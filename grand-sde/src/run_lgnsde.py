...
def main(cmd_opt):
  ...
  save_probabilities_and_labels(prob_mean_cpu, prob_var=prob_var_cpu, model_name='lgnsde', base_directory=base_directory, task_index=task_index, labels=data.y.detach().cpu().numpy(), is_ODD=opt['OOD'])
